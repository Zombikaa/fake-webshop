const NoiNadrag = () => {
  ...
  return (
    <div className="flex h-screen items-center justify-between">
        <div>
            <img src="/assets/Termékek/Ruhák/nadrag-noi.png" className="mx-auto mb-2" width={300} />
            <p className="text-center font-bold text-xl">Vízlepergető bélelt rózsaszín női nadrág <span className="p-1 bg-pink-400 rounded-md text-white font-bold">Nő</span></p>
            <img
            ...
            <div className="bg-gray-200 p-4 rounded-[5px]">
                ...
                <div className="flex items-center mt-2 bg-gray-300 p-3 rounded-md">
                    ...
                    <div className="flex-col">
                    <p>Király Réka</p>
                    <p className="opacity-50 text-gray-800 italic">Nagyon tetszik ez a nadág!!!!</p>
                    </div>
                </div>
            </div>
        </div>
        <div className="p-6 border-[#00000038] border-2 rounded-[5px]">
            <div className="bg-gray-200 p-4 rounded-[5px]">
                <p className="font-bold text-red-600 text-2xl">6.990 Ft</p>
