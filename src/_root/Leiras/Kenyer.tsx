const Kenyer = () => {
  ...
  return (
    <div className="flex h-screen items-center justify-between">
        <div>
            <img src="/assets/Termékek/Élelmiszerek/kenyer.png" className="mx-auto mb-2" width={300} />
            <p className="text-center font-bold text-xl">Falusi kenyér 1KG</p>
            <img
            ...
            <div className="bg-gray-200 p-4 rounded-[5px]">
                ...
                <div className="flex items-center bg-gray-300 p-3 rounded-md">
                    ...
                    <p>Rácz Ádám</p>
                    <p className="opacity-50 text-gray-800 italic">Nagyon finom!</p>
                    </div>
                </div>
                ...
                <div className="flex items-center bg-gray-300 p-3 rounded-md">
                    ...
                    <div className="flex-col">
                    <p>Fejes Éva</p>
                    <p className="opacity-50 text-gray-800 italic">Nem jó!</p>
                    </div>
                </div>
            </div>
        </div>
        <div className="p-6 border-[#00000038] border-2 rounded-[5px]">
            <div className="bg-gray-200 p-4 rounded-[5px]">
                <p className="font-bold text-red-600 text-2xl">990 Ft</p>
