const Bojler = () => {
  ...
  return (
    <div className="flex h-screen items-center justify-between">
        <div>
            <img src="/assets/Termékek/Eszközök/bojler.png" className="mx-auto mb-2" width={300} />
            <p className="text-center font-bold text-xl">Stiebel Eltron SHO AC 1000 12 bojler álló 1000 L 12 kW</p>
            <img
        ...
        <div className="p-6 border-[#00000038] border-2 rounded-[5px]">
            <div className="bg-gray-200 p-4 rounded-[5px]">
                <p className="font-bold text-red-600 text-2xl">699.990 Ft</p>
                <p>Forgalmazza a webshop <span className=" text-green-500">(raktáron)</span></p>
            </div>
            <br />
           <ul>
                <li>- Álló tároló központi melegvíz-ellátáshoz</li>
                <li>- Egyszerű hőmérséklet-beállítás</li>
                <li>- Hőszigetelés az alacsony energiafogyasztáshoz opcionális tartozékként kapható</li>
                <li>- Az állvány hátulján két lyuk található a készlet falhoz rögzítéséhez</li>
                <li>- Nagy számú vízvételi helyhez használható</li>
           </ul>
