const Szoknya = () => {
  ...
  return (
    <div className="flex h-screen items-center justify-between">
        <div>
            <img src="/assets/Termékek/Ruhák/szoknya.png" className="mx-auto mb-2" width={300} />
            <p className="text-center font-bold text-xl">Fila Skort Nicole Scuba Blue Női szoknya <span className="p-1 bg-pink-400 rounded-md text-white font-bold">Nő</span></p>
            <img
        ...
        <div className="p-6 border-[#00000038] border-2 rounded-[5px]">
            <div className="bg-gray-200 p-4 rounded-[5px]">
                <p className="font-bold text-red-600 text-2xl">2.990 Ft</p>
