const Funyiro = () => {
  ...
  return (
    <div className="flex h-screen items-center justify-between">
        <div>
            <img src="/assets/Termékek/Eszközök/funyiro.png" className="mx-auto mb-2" width={300} />
            <p className="text-center font-bold text-xl">HRN 536 VYE Önjáró Fűnyíró</p>
            <img
            ...
            <div className="bg-gray-200 p-4 rounded-[5px]">
                ...
                <div className="flex items-center bg-gray-300 p-3 rounded-md">
                    ...
                    <p>Fejes Éva</p>
                    <p className="opacity-50 text-gray-800 italic">Számomra túl bonyolultnak tűnik a használata.</p>
                    </div>
                </div>
                <div className="flex items-center bg-gray-300 mt-2 mb-2 p-3 rounded-md">
                    ...
                    <div className="flex-col">
                    <p>Nagy Anna</p>
                    <p className="opacity-50 text-gray-800 italic">Egyszerűen zseniális!</p>
                    </div>
                </div>
                <div className="flex items-center bg-gray-300 p-3 rounded-md">
        ...
        <div className="p-6 border-[#00000038] border-2 rounded-[5px]">
            <div className="bg-gray-200 p-4 rounded-[5px]">
                <p className="font-bold text-red-600 text-2xl">59.990 Ft</p>
                <p>Forgalmazza a webshop <span className=" text-red-500">(nincs raktáron)</span></p>
            </div>
            <br />
           <ul>
                <li>- 3,2 kW teljesítményre is képes</li>
                <li>- Fűgyűjtő mérete (l): 70</li>
                <li>- Ház anyaga: Acél</li>
                <li>- Tömeg: 36 kg</li>
           </ul>
