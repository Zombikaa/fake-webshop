const Furo = () => {
  ...
  return (
    <div className="flex h-screen items-center justify-between">
        <div>
            <img src="/assets/Termékek/Eszközök/furo.png" className="mx-auto mb-2" width={300} />
            <p className="text-center font-bold text-xl">Bosch GSR 18V-60 C akkus szénkefe nélküli fúró-csavarozó</p>
            <img
            ...
            <div className="bg-gray-200 p-4 rounded-[5px]">
                ...
                <div className="flex items-center bg-gray-300 p-3 rounded-md">
                    ...
                    <p>Rácz Ádám</p>
                    <p className="opacity-50 text-gray-800 italic">Nem olyan jó.</p>
                    </div>
                </div>
                ...
                <div className="flex items-center bg-gray-300 p-3 rounded-md">
                    ...
                    <div className="flex-col">
                    <p>Fejes Éva</p>
                    <p className="opacity-50 text-gray-800 italic">Hangos!</p>
                    </div>
                </div>
            </div>
        </div>
        <div className="p-6 border-[#00000038] border-2 rounded-[5px]">
            <div className="bg-gray-200 p-4 rounded-[5px]">
                <p className="font-bold text-red-600 text-2xl">19.990 Ft</p>
                <p>Forgalmazza a webshop <span className=" text-green-500">(raktáron)</span></p>
            </div>
            <br />
           <ul>
                <li>- Forgatónyomaték (puha/kemény/max): 31/60/- Nm</li>
                <li>- Maximális furatátmérő, fa: 38 mm-ben</li>
                <li>- Csavarátmérő, max. : 10 mm-ben</li>
                <li>- Szegmensek: Nehéz feladat tartománya</li>
           </ul>
