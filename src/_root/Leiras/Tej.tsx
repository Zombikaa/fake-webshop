const Tej = () => {
  ...
  return (
    <div className="flex h-screen items-center justify-between">
        <div>
            <img src="/assets/Termékek/Élelmiszerek/tej.png" className="mx-auto mb-2" width={300} />
            <p className="text-center font-bold text-xl">Magyar Tej UHT tej 2,8% 1l</p>
            <img
        ...
        <div className="p-6 border-[#00000038] border-2 rounded-[5px]">
            <div className="bg-gray-200 p-4 rounded-[5px]">
                <p className="font-bold text-red-600 text-2xl">420 Ft</p>
